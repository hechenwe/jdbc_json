...
public class SoonJson {
	...
	private static String getJson4Map(Map<String, Object> map) {
		...
		for (Entry<String, Object> en : map.entrySet()) {
			...
			String key = T2E.toField (en.getKey());
			if (n > 0) {
				json.append(",\"" + key + "\":");
			} else {
				json.append("\"" + key + "\":");
	...
	public static Map<String, Object> getMap(String json) {
		...
		Boolean bool = isJsonObject(json);
		if (bool) {
	...
	public static void main(String[] args) {
		...
		// map.put("name",
		// "[{\"knowledge_name\":\"八年级上册\",\"ctb_code\":\"69\"},{\"knowledge_name\":\"八年级下册\",\"ctb_code\":\"70\"}]");
		...
		String json = "{\"student\":{\"knowledge_name\":\"八年级上册\",\"ctb_code\":\"69\"}}";
